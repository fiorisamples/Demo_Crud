		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#demonwcrudui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"demonwcrudui-display": {
								"semanticObject": "demonwcrudui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demonwcrudui",
									"url": sap.ui.require.toUrl("demonwcrudui")
								}
							}
						}
					}
